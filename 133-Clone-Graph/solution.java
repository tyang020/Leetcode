...
public class Solution {
    ...
    public UndirectedGraphNode cloneGraph(UndirectedGraphNode node) {
        ...
        if (map.containsKey(node.lable))
            return map.get(node.lable);
        UndirectedGraphNode cloned = new UndirectedGraphNode(node.lable);  // clone lable
        map.put(node.lable, cloned);
